namespace SchoolEats.Common
{
	...
	{
		//Dish
		public const string DishNameLengthError = "Името трябва да бъде от {1} до {0} символа!";
		public const string RequiredField = "Полето {0} е задължително!";
		public const string DishDescriptionLengthError = "Описанието трябва да бъде от {1} до {0} символа!";
